...
Route::middleware('guest:tenant')->prefix('tenant')->name('tenant.')->group(function () {
    Route::get('/login', [AuthController::class, 'showTenantLoginForm'])->name('login');
...
Route::middleware(['auth:web'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/roles/{role}/permissions', [RoleController::class, 'setPermissions'])->name('roles.permissions');
...
// Authenticated routes - Legacy (for backward compatibility)
